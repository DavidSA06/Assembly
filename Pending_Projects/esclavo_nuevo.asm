...
gas		bsf		PORTA,1; Motor2 "pata 15 L293" GAS
		bcf		PORTA,0;Motor1 "pata 10 L293" Aire
...
aire	call	borra; borra la pantalla LCD
		bcf		PORTA,1; Motor2 "pata 15 L293" GAS
		bsf		PORTA,0;Motor1 "pata 10 L293" Aire	
		movlw	.68	;  (caracter: D)
		call	envia; envia caracter a la LCD
		movlw	.69;  (caracter: E)
		call	envia; envia caracter a la LCD		 		
...
auto	clrf	vivi
		movlw	.0
		movwf	vivi
		bsf		PORTA,0; inyectando aire
		BcF		PORTA,1; inyectando gas 
		call	borra
