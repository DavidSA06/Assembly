...
SENSOR1H				EQU					32H
HUMEDADA				EQU					33H								;DATOS GUARDADOS PARA ENVIO
HUMEDADB				EQU					34H
TEMPERATURAA			EQU					35H
TEMPERATURAB			EQU					36H
...
INICIO					BSF					STATUS,RP0						;CAMBIO AL BANCO 1
						...
						MOVWF				TRISA							;ENTRADAS PARA SENSORES ANALOGICOS, ENTRADAS PARA SENSORES DIGITALES
						...
						MOVWF				TRISE
						MOVLW				B'00000000'						;ENTRADAS PARA CONFIGURACION DE SENSORES DIGITALES
						MOVWF				TRISD

;;;;;;;;;;;;;;;;;;;;;;;;CONFIGURACION DE PULL-UP Y TEMPORIZACION

						MOVLW				B'00000010'						;PULL-UP HABILITADO
						MOVWF				OPTION_REG						;PREESCALADOR 1:8
...
;;;;;;;;;;;;;;;;;;;;;;;;CONFIGURACIÓN DEL CONVERSOR ANALOGICO-DIGITAL
						...
						MOVLW				B'10000100'						;ADRESL, TOSC*32, JUSTIFICADO A LA DERECHA 6 BITS VACIOS EN ADRESH
						MOVWF				ADCON1							;AN7 /D/D/D/D/A/D/A/A/ AN0
						BCF					STATUS,RP0						;CAMBIO A BANCO 0
...
;;;;;;;;;;;;;;;;;;;;;;;;LIMPIEZA DE REGISTROS
						...
						MOVLW				.10
						MOVWF				CONTC							;CONTADOR DE CICLOS	10:1
						CLRF				VALORL
						CLRF				VALORH
						CLRF				CONTBIT
						CLRF				BYTE
...
;;;;;;;;;;;;;;;;;;;;;;;;CAMBIAR A RUNNING STATUS (TRANSMISIÓN DEL PIC)
						...
						MOVLW				B'00001011'						;(RA4 NO SIRVE PARA EL CONVERSOR NO CONTIENE UN AN!)
						MOVWF				TRISA							;CAMBIAR PINES DIGITALES COMO SALIDA PARA DHT22
						BCF					STATUS,RP0						;CAMBIO AL BANCO 0
						BCF					PORTA,2							;ENVIAR SENAL GND AL SENSOR
						CALL				RETRASO
						BCF					STATUS,RP1
						BSF					STATUS,RP0						;CAMBIO AL BANCO 1
						MOVLW				B'00101111'						;(RA4 NO SIRVE PARA EL CONVERSOR NO CONTIENE UN AN!)
						...
						BCF					STATUS,RP1
						BCF					STATUS,RP0						;CAMBIO AL BANCO 0
						BTFSC				PORTA,2							;ESPERAR A LA RESPUESTA BAJA DEL SENSOR POR 20~40 us
						GOTO				$-1
						BTFSS				PORTA,2							;ESPERAR A LA RESPUESTA ALTA DEL SENSOR POR 80 us
						GOTO				$-1
						BTFSC				PORTA,2							;ESPERAR EL INICIO DE LA TRANSMISION POR 80 us
						GOTO				$-1
...
RETRASO					MOVLW				.200
						...
						MOVLW				.194							;99.2us (1000 MINIMO,20000 MAXIMO)
...
CINCUENTA				BTFSS				PORTA,2							;ESPERAR 50 us
						GOTO				$-1
						BCF					INTCON,T0IF						;BAJAR LA BANDERA T0IF 
						MOVLW				.231
						MOVWF				TMR0							;CONTAR 40us (26~28us A 70us)
						BTFSC				PORTA,2							;ESPERAR EL FINAL DEL BIT
						GOTO				$-1
...
SUMA					MOVFW				REGISTRO1						;MOVER SUMA1 A W
						...
						SUBWF				REGISTRO5,1						;RESTARLE LA SUMA A LA PARIDAD
